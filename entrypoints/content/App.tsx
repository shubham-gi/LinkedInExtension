...
// const svgData = `<svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
...
import Modal from "./components/Modal"; // No need to include the .tsx extension
...
const App: React.FC = () => {
  ...
  useEffect(() => {
    const insertButton = () => {
      ...
      document.addEventListener("focusin", (event: FocusEvent) => {
        ...
        if (target.classList.contains("msg-form__contenteditable")) {
          ...
          console.log("Message Box Found or Focused");
          ...
          if (messageBox && !document.getElementById("customButton")) {
            ...
            button.src = url;
            button.className = "customButton"; // Changed to className
            button.id = "customButton"; // Add an ID to prevent duplicates
    ...
    return () => {
      document.removeEventListener("focusin", insertButton);
    };
  }, []);
